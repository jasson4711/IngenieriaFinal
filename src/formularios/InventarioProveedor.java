 ...
 * @author Usuario
 */
public class InventarioProveedor extends javax.swing.JDialog {
    ...
    public void establecerTamañoColumnas() {
        ...
        modeloColumna.getColumn(2).setPreferredWidth(70);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarioProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                InventarioProveedor dialog = new InventarioProveedor(new javax.swing.JFrame(), true);
